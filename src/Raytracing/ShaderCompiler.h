...
class NebShaderCompiler
{
public:
    NebShaderCompiler();

    NebShaderCompiler(const NebShaderCompiler&) = delete;
    NebShaderCompiler& operator=(const NebShaderCompiler&) = delete;

    ~NebShaderCompiler() = default;

    NebShader CompileShader(const std::string& filepath,
