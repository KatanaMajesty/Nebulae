...
BOOL RayTracer::IsDxgiAdapterRaytracingSupported(ComPtr<ID3D12Device> device) const
{
...
BOOL RayTracer::IsDxgiAdapterSuitable(IDXGIAdapter3* DxgiAdapter, const DXGI_ADAPTER_DESC1& desc) const
{
...
BOOL RayTracer::QueryMostSuitableDeviceAdapter()
{
...
void RayTracer::InitCommandQueues()
{
...
void RayTracer::InitSwapchain(HWND hwnd)
{
